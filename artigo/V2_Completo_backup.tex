...
A análise exploratória inicial foi conduzida em Python 3.12 com as bibliotecas \texttt{pandas} e \texttt{numpy}. A análise estatística definitiva, incluindo testes, gráficos e modelagem, foi realizada em R 4.5.2 \cite{rcoreteam2024}, utilizando os pacotes \texttt{ggplot2}, \texttt{corrplot}, \texttt{PerformanceAnalytics} e \texttt{car}.
